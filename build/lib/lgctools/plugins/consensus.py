...
from ..utils.utils import get_counts, sort_dict, next_key, compare_two_samples, \
    print_log, get_list_from_dict, remove_elements
from ..utils.data_processing import subset_gtdata, merge_gtdata, fill_gaps_gtdata
from ..utils.definitions import MISSING_CALLS
from ..classes.Data import MS, SM
...
def process_consensus(options, smdata, msdata, markers):
    ...
    cons_rep_msdata = merge_gtdata(cons_msdata, rep_msdata, 'marker-fast')
    cons_rep_smdata = merge_gtdata(cons_smdata, rep_smdata, 'sample-fast')
    ...
    msdata = merge_gtdata(cons_msdata, msdata, 'marker-fast')
    smdata = merge_gtdata(cons_smdata, smdata, 'sample-fast')
